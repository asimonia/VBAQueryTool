VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmDBLogin 
   Caption         =   "Set Oracle Login Parameters Fixed Assets"
   ClientHeight    =   3480
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   4710
   OleObjectBlob   =   "frmDBLogin.frx":0000
...
Private Sub cmdSaveLoginParams_Click()
   ...
   Else
      ...
      prmBeginningNextMonth = BeginDate(cboDate.Text, cboYear.Text)
